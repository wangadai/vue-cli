...
<style scoped>
    ...
    .loading.ball-pulse{margin: 10px 0;}
    ...
    .loading.ball-pulse > div {background-color: #5ebeaa; width: 15px; height: 15px; border-radius: 100%; margin: 2px; -webkit-animation-fill-mode: both; animation-fill-mode: both; display: inline-block; }
</style>